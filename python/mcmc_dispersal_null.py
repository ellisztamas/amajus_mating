...
print('\nMCMC analysis for 3-parameter pollen dispersal in A. majus, starting with mix = 0.')
logfile.write('MCMC analysis for 3-parameter pollen dispersal in A. majus, starting with mix = 0.\n')
