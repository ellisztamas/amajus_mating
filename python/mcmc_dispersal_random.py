...
print('\nMCMC analysis for 3-parameter pollen dispersal in A. majus, starting with random values.')
logfile.write('MCMC analysis for 3-parameter pollen dispersal in A. majus, starting with random values.\n')
